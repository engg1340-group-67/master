...
vector<double> predict_mean(string name, string Date){
	...
	if (day < 2){
		...
		filename = name+month_s+big_small[day-1];
		sum.push_back(connector(filename));
	
		filename = name+month_s+big_small[day-2];
		sum.push_back(connector(filename));
	}
...
int predict_main(string name,string Date) {
	system("cls");
	//storing
	string confirm;
	double price = 0;
	...
	cout << fixed << setprecision << v[5];
	cout << "(100%)";
	fout << fixed << setprecision << v[5];
	fout << "(100%)";
	cout << endl;
	fout << endl;
	cout << "=================================================================================\n";
	...
	cout << fixed << setprecision << p[5];
	cout << "(100%)";
	fout << fixed << setprecision << p[5];
	fout << "(100%)";
	cout << endl;
	fout << endl;
	cout << "============================================================================\n";
