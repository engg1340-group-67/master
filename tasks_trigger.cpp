...
void read_task(Node *& head, Node * & tail) {
	...
	//data_template bonus(1);
	//bonus.no.push_back(1);
	//bonus.name.push_back(bonus);
	//bonus.price.push_back(price) // here you input the total removed moeny
	//								here require him to cin date
	//filename = name+Date+"gain.txt"
	//add_write(6, data_template data, filename, 1)
	//						end here
